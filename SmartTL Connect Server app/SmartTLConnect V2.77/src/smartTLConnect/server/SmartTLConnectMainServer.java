...
//***************************************************************************** 
//
//  Module name:    SmartTLConnectMainServer.java
//  Author:    Pedro Silva
//***************************************************************************** 

package smartTLConnect.server;
...
/**
 * <p>Title:       SITRAFFIC smartTL Connect - SmartTLConnectMainServer.java</p>
...
public class SmartTLConnectMainServer implements ExternalIf {
  ...
  public static int[] statusDelay = {0};
  ...
  *
  */
  public SmartTLConnectMainServer() throws NumberFormatException, IOException {
  ...
  public void createIntersections() throws NumberFormatException, IOException{
    ...
    statusDelay = new int[numIntersections];
  ...
  */
  public static void main(String[] args) throws IOException, InterruptedException{
    ...
    boolean run = true;
    //Temporary variable implemented on 2.74 to diminish the message send bug.
    ...
    SimpleExternalIfSoapServer server = new SimpleExternalIfSoapServer(85, new SmartTLConnectMainServer());
    server.start();
    ...
    while(run){
      ...
      SmartTLConnectInputServer simpleserver = new SmartTLConnectInputServer();
      //Checks for information coming from smartGuard.
      if (putds != null && sendMessageDelay == 0){
    	  putCheckContent(); 
      }
      
      if (contains(statusUserChange, 1)){
