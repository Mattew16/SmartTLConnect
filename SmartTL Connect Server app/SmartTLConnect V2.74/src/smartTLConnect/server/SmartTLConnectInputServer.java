...
//***************************************************************************** 
//
//  Module name:    SmartTLConnectInputServer.java
//  Author:    Pedro Silva
//***************************************************************************** 
...
/**
 * <p>Title:       SITRAFFIC smartTL Connect - SmartTLConnectInputServer.java</p>
...
*/
public class SmartTLConnectInputServer{
	...
	/**  Instantiates an instance of the SmartTLConnectInputServer class and initilaizes it.
	...
	*/
	...
	public int[] init(int[] statusInput, int[] statusUserChange) throws IOException{
	    ...
	    Socket socket = null;
	    int connections = statusInput.length * 2;
	    int y = 0;
