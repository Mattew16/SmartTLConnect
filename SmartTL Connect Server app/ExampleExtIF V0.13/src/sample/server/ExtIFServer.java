...
public class ExtIFServer implements ExternalIf
{
    ...
    public static int[] status = {9, 9, 9, 9, 9}; 
    ...
    */
    public ExtIFServer()
    {
        ...
        String[] intersectionids = { "Intersection_01", "Intersection_02", "Intersection_03", "Intersection_04", "Intersection_05"};
        int i = 0;
    ...
    public static void main(String[] args) throws IOException, InterruptedException
    {
        ...
        int count =0, delay = 0;
        int[] previousStatus = {9, 9, 9, 9, 9};
        SpType[] previousStatusControl = {new SpType(), new SpType(), new SpType(), new SpType(), new SpType()};
        for (int i2 = 0; i2 < status.length; i2++){
        	previousStatusControl[i2].setSpNr((short) 1);
        }
       
        String[] intersectionids = { "Intersection_01", "Intersection_02", "Intersection_03", "Intersection_04", "Intersection_05"};
        int z;
        int x = 2; //Time to wait for input
