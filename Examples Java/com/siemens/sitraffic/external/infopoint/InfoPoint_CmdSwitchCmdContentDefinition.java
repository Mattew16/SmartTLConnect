...
public class InfoPoint_CmdSwitchCmdContentDefinition  implements java.io.Serializable {
     ...
     * contents. */
    private com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage[] image;
    ...
    public InfoPoint_CmdSwitchCmdContentDefinition(
           com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage[] image,
     ...
     * contents.
     */
    public com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage[] getImage() {
        return image;
    }
     ...
     * contents.
     */
    public void setImage(com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage[] image) {
        this.image = image;
    }

    public com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage getImage(int i) {
        return this.image[i];
    }

    public void setImage(int i, com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImage _value) {
        this.image[i] = _value;
    }
