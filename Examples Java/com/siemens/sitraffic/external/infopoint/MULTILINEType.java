...
public class MULTILINEType  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType[] POSITION;
    ...
    private com.siemens.sitraffic.external.infopoint.Effect_enum effect;  // attribute

    public MULTILINEType() {
    }

    public MULTILINEType(
           com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType[] POSITION,
           ...
           com.siemens.sitraffic.external.infopoint.Effect_enum effect) {
     ...
     */
    public com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType[] getPOSITION() {
        return POSITION;
    }
     ...
     */
    public void setPOSITION(com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType[] POSITION) {
        this.POSITION = POSITION;
    }

    public com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType getPOSITION(int i) {
        return this.POSITION[i];
    }

    public void setPOSITION(int i, com.siemens.sitraffic.external.infopoint.MULTILINEPOSITIONType _value) {
     ...
     * @return effect
     */
    public com.siemens.sitraffic.external.infopoint.Effect_enum getEffect() {
        return effect;
    }
     ...
     * @param effect
     */
    public void setEffect(com.siemens.sitraffic.external.infopoint.Effect_enum effect) {
        this.effect = effect;
    }
