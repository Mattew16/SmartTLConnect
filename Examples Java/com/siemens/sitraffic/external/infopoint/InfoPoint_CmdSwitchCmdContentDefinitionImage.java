...
public class InfoPoint_CmdSwitchCmdContentDefinitionImage  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText[] text;
    ...
    public InfoPoint_CmdSwitchCmdContentDefinitionImage(
           com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText[] text,
     ...
     * the position within the image.
     */
    public com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText[] getText() {
        return text;
    }
     ...
     * the position within the image.
     */
    public void setText(com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText[] text) {
        this.text = text;
    }

    public com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText getText(int i) {
        return this.text[i];
    }

    public void setText(int i, com.siemens.sitraffic.external.infopoint.InfoPoint_CmdSwitchCmdContentDefinitionImageText _value) {
        this.text[i] = _value;
    }
