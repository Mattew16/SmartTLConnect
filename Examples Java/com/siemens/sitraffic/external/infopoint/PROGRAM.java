...
public class PROGRAM  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.infopoint.PICTUREType[] PICTURE;
    ...
    public PROGRAM(
           com.siemens.sitraffic.external.infopoint.PICTUREType[] PICTURE,
           java.lang.String id,
     ...
     * (duration is mandatory if only one picture defined)
     */
    public com.siemens.sitraffic.external.infopoint.PICTUREType[] getPICTURE() {
        return PICTURE;
    }
     ...
     * (duration is mandatory if only one picture defined)
     */
    public void setPICTURE(com.siemens.sitraffic.external.infopoint.PICTUREType[] PICTURE) {
        this.PICTURE = PICTURE;
    }

    public com.siemens.sitraffic.external.infopoint.PICTUREType getPICTURE(int i) {
        return this.PICTURE[i];
    }

    public void setPICTURE(int i, com.siemens.sitraffic.external.infopoint.PICTUREType _value) {
