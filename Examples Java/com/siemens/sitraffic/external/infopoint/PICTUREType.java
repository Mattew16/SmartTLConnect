...
public class PICTUREType  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.infopoint.MATRIXType[] MATRIX;

    /* definition of display elements with line orientated format */
    private com.siemens.sitraffic.external.infopoint.MULTILINEType[] MULTILINE;
    ...
    private com.siemens.sitraffic.external.infopoint.SEGMENTType[] SEGMENT;

    /* definition of prism orientated display element (only index
     * of prism given) */
    private com.siemens.sitraffic.external.infopoint.PRISMType[] PRISM;

    /* rendered whole contents into "imgtype" (e.g. jpg) */
    private com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED[] RENDERED;
    ...
    public PICTUREType(
           com.siemens.sitraffic.external.infopoint.MATRIXType[] MATRIX,
           com.siemens.sitraffic.external.infopoint.MULTILINEType[] MULTILINE,
           com.siemens.sitraffic.external.infopoint.SEGMENTType[] SEGMENT,
           com.siemens.sitraffic.external.infopoint.PRISMType[] PRISM,
           com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED[] RENDERED,
           java.lang.String id,
     ...
     * and free font capabilities
     */
    public com.siemens.sitraffic.external.infopoint.MATRIXType[] getMATRIX() {
        return MATRIX;
    }
     ...
     * and free font capabilities
     */
    public void setMATRIX(com.siemens.sitraffic.external.infopoint.MATRIXType[] MATRIX) {
        this.MATRIX = MATRIX;
    }

    public com.siemens.sitraffic.external.infopoint.MATRIXType getMATRIX(int i) {
        return this.MATRIX[i];
    }

    public void setMATRIX(int i, com.siemens.sitraffic.external.infopoint.MATRIXType _value) {
     ...
     */
    public com.siemens.sitraffic.external.infopoint.MULTILINEType[] getMULTILINE() {
        return MULTILINE;
    }
     ...
     */
    public void setMULTILINE(com.siemens.sitraffic.external.infopoint.MULTILINEType[] MULTILINE) {
        this.MULTILINE = MULTILINE;
    }

    public com.siemens.sitraffic.external.infopoint.MULTILINEType getMULTILINE(int i) {
        return this.MULTILINE[i];
    }

    public void setMULTILINE(int i, com.siemens.sitraffic.external.infopoint.MULTILINEType _value) {
     ...
     * position is  based on character position, not pixel orientated)
     */
    public com.siemens.sitraffic.external.infopoint.SEGMENTType[] getSEGMENT() {
        return SEGMENT;
    }
     ...
     * position is  based on character position, not pixel orientated)
     */
    public void setSEGMENT(com.siemens.sitraffic.external.infopoint.SEGMENTType[] SEGMENT) {
        this.SEGMENT = SEGMENT;
    }

    public com.siemens.sitraffic.external.infopoint.SEGMENTType getSEGMENT(int i) {
        return this.SEGMENT[i];
    }

    public void setSEGMENT(int i, com.siemens.sitraffic.external.infopoint.SEGMENTType _value) {
     ...
     * of prism given)
     */
    public com.siemens.sitraffic.external.infopoint.PRISMType[] getPRISM() {
        return PRISM;
    }
     ...
     * of prism given)
     */
    public void setPRISM(com.siemens.sitraffic.external.infopoint.PRISMType[] PRISM) {
        this.PRISM = PRISM;
    }

    public com.siemens.sitraffic.external.infopoint.PRISMType getPRISM(int i) {
        return this.PRISM[i];
    }

    public void setPRISM(int i, com.siemens.sitraffic.external.infopoint.PRISMType _value) {
        this.PRISM[i] = _value;
    }
     ...
     */
    public com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED[] getRENDERED() {
        return RENDERED;
    }
     ...
     */
    public void setRENDERED(com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED[] RENDERED) {
        this.RENDERED = RENDERED;
    }

    public com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED getRENDERED(int i) {
        return this.RENDERED[i];
    }

    public void setRENDERED(int i, com.siemens.sitraffic.external.infopoint.PICTURETypeRENDERED _value) {
