...
public class LocationTypeNetNet  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung[] attributsaenderung;
    ...
    public LocationTypeNetNet(
           ...
           com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung[] attributsaenderung) {
     ...
     * des Vorgaengers. Wenn in keinem Knoten verfügbar, dann gilt der Defaultwert.
     */
    public com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung[] getAttributsaenderung() {
     ...
     * des Vorgaengers. Wenn in keinem Knoten verfügbar, dann gilt der Defaultwert.
     */
    public void setAttributsaenderung(com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung[] attributsaenderung) {
        this.attributsaenderung = attributsaenderung;
    }

    public com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung getAttributsaenderung(int i) {
        return this.attributsaenderung[i];
    }

    public void setAttributsaenderung(int i, com.siemens.sitraffic.external.environmentsensor.LocationTypeNetNetAttributsaenderung _value) {
