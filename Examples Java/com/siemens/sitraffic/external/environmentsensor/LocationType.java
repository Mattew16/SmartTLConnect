...
public class LocationType  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads[] roads;

    /* Georeference by coordinates */
    private com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom[] geom;

    /* GeoReference by links */
    private com.siemens.sitraffic.external.environmentsensor.LocationTypeNet[] net;
    ...
    public LocationType(
           ...
           com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads[] roads,
           com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom[] geom,
           com.siemens.sitraffic.external.environmentsensor.LocationTypeNet[] net) {
     ...
     */
    public com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads[] getRoads() {
        return roads;
    }
     ...
     */
    public void setRoads(com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads[] roads) {
        this.roads = roads;
    }

    public com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads getRoads(int i) {
        return this.roads[i];
    }

    public void setRoads(int i, com.siemens.sitraffic.external.environmentsensor.LocationTypeRoads _value) {
        this.roads[i] = _value;
    }
     ...
     */
    public com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom[] getGeom() {
        return geom;
    }
     ...
     */
    public void setGeom(com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom[] geom) {
        this.geom = geom;
    }

    public com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom getGeom(int i) {
        return this.geom[i];
    }

    public void setGeom(int i, com.siemens.sitraffic.external.environmentsensor.LocationTypeGeom _value) {
        this.geom[i] = _value;
    }
     ...
     */
    public com.siemens.sitraffic.external.environmentsensor.LocationTypeNet[] getNet() {
        return net;
    }
     ...
     */
    public void setNet(com.siemens.sitraffic.external.environmentsensor.LocationTypeNet[] net) {
        this.net = net;
    }

    public com.siemens.sitraffic.external.environmentsensor.LocationTypeNet getNet(int i) {
        return this.net[i];
    }

    public void setNet(int i, com.siemens.sitraffic.external.environmentsensor.LocationTypeNet _value) {
        this.net[i] = _value;
    }
