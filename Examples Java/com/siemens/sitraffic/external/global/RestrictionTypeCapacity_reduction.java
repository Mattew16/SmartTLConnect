...
public class RestrictionTypeCapacity_reduction  implements java.io.Serializable, org.apache.axis.encoding.SimpleType {
    ...
    private com.siemens.sitraffic.external.global.RestrictionTypeCapacity_reductionKind kind;  // attribute
     ...
     * @return kind
     */
    public com.siemens.sitraffic.external.global.RestrictionTypeCapacity_reductionKind getKind() {
        return kind;
    }
     ...
     * @param kind
     */
    public void setKind(com.siemens.sitraffic.external.global.RestrictionTypeCapacity_reductionKind kind) {
        this.kind = kind;
    }
