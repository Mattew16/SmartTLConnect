...
public class LocationType  implements java.io.Serializable {
    ...
    /* road description */
    private com.siemens.sitraffic.external.global.LocationTypeRoaddescription roaddescription;

    /* coordinates */
    private com.siemens.sitraffic.external.global.LocationTypeCo_description[] co_description;

    /* will be used only for object types containing traffic messages */
    private com.siemens.sitraffic.external.global.RestrictionType[] restriction;

    /* predefined location code, e.g. RDS- TMC location code or  other
     * fixed predefined location ids */
    private com.siemens.sitraffic.external.global.LocationTypeReference[] reference;

    /* location code according to a detection net or original street
     * map with link ids and startnodes */
    private com.siemens.sitraffic.external.global.LocationTypeNetref[] netref;
    ...
    public LocationType(
           ...
           com.siemens.sitraffic.external.global.LocationTypeRoaddescription roaddescription,
           com.siemens.sitraffic.external.global.LocationTypeCo_description[] co_description,
           com.siemens.sitraffic.external.global.RestrictionType[] restriction,
           com.siemens.sitraffic.external.global.LocationTypeReference[] reference,
           com.siemens.sitraffic.external.global.LocationTypeNetref[] netref) {
           this.city = city;
     ...
     * 
     * @return roaddescription   * road description
     */
    public com.siemens.sitraffic.external.global.LocationTypeRoaddescription getRoaddescription() {
     ...
     * 
     * @param roaddescription   * road description
     */
    public void setRoaddescription(com.siemens.sitraffic.external.global.LocationTypeRoaddescription roaddescription) {
        this.roaddescription = roaddescription;
    }
     ...
     */
    public com.siemens.sitraffic.external.global.LocationTypeCo_description[] getCo_description() {
     ...
     */
    public void setCo_description(com.siemens.sitraffic.external.global.LocationTypeCo_description[] co_description) {
        this.co_description = co_description;
    }

    public com.siemens.sitraffic.external.global.LocationTypeCo_description getCo_description(int i) {
        return this.co_description[i];
    }

    public void setCo_description(int i, com.siemens.sitraffic.external.global.LocationTypeCo_description _value) {
     ...
     * 
     * @return restriction   * will be used only for object types containing traffic messages
     */
    public com.siemens.sitraffic.external.global.RestrictionType[] getRestriction() {
        return restriction;
    }
     ...
     * 
     * @param restriction   * will be used only for object types containing traffic messages
     */
    public void setRestriction(com.siemens.sitraffic.external.global.RestrictionType[] restriction) {
        this.restriction = restriction;
    }

    public com.siemens.sitraffic.external.global.RestrictionType getRestriction(int i) {
        return this.restriction[i];
    }

    public void setRestriction(int i, com.siemens.sitraffic.external.global.RestrictionType _value) {
     ...
     * fixed predefined location ids
     */
    public com.siemens.sitraffic.external.global.LocationTypeReference[] getReference() {
        return reference;
    }
     ...
     * fixed predefined location ids
     */
    public void setReference(com.siemens.sitraffic.external.global.LocationTypeReference[] reference) {
        this.reference = reference;
    }

    public com.siemens.sitraffic.external.global.LocationTypeReference getReference(int i) {
        return this.reference[i];
    }

    public void setReference(int i, com.siemens.sitraffic.external.global.LocationTypeReference _value) {
     ...
     * map with link ids and startnodes
     */
    public com.siemens.sitraffic.external.global.LocationTypeNetref[] getNetref() {
        return netref;
    }
     ...
     * map with link ids and startnodes
     */
    public void setNetref(com.siemens.sitraffic.external.global.LocationTypeNetref[] netref) {
        this.netref = netref;
    }

    public com.siemens.sitraffic.external.global.LocationTypeNetref getNetref(int i) {
        return this.netref[i];
    }

    public void setNetref(int i, com.siemens.sitraffic.external.global.LocationTypeNetref _value) {
