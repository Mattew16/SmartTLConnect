...
public class TriggerAreaDescription  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter[] filter;

    public TriggerAreaDescription() {
    }
    ...
    public TriggerAreaDescription(
           ...
           com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter[] filter) {
           this.id = id;
           this.name = name;
           this.type = type;
    ...
    /**
     * Gets the id value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Sets the id value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Gets the name value for this TriggerAreaDescription.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this TriggerAreaDescription.
     * 
     * @param name
     */
    ...
    /**
     * Gets the type value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Sets the type value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Gets the position value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Sets the position value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Gets the direction value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Sets the direction value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Gets the size value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Sets the size value for this TriggerAreaDescription.
     * 
    ...
    /**
     * Gets the filter value for this TriggerAreaDescription.
     * 
     * @return filter
     */
    public com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter[] getFilter() {
        return filter;
    }


    /**
     * Sets the filter value for this TriggerAreaDescription.
     * 
     * @param filter
     */
    public void setFilter(com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter[] filter) {
        this.filter = filter;
    }

    public com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter getFilter(int i) {
        return this.filter[i];
    }

    public void setFilter(int i, com.siemens.sitraffic.external.triggerarea.TriggerAreaDescriptionFilter _value) {
        this.filter[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TriggerAreaDescription)) return false;
        TriggerAreaDescription other = (TriggerAreaDescription) obj;
