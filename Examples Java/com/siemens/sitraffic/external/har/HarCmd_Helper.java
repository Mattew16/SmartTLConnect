...
public class HarCmd_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HarCmd.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sitraffic.siemens.com/ws/external/har", "HarCmd"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://sitraffic.siemens.com/ws/external/har", ">HarCmd>Playlist"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
