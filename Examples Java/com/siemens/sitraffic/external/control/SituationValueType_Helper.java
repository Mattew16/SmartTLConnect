/**
 * SituationValueType_Helper.java
 *
...
public class SituationValueType_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SituationValueType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sitraffic.siemens.com/ws/external/control", "SituationValueType"));
        ...
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("bmp");
        attrField.setXmlName(new javax.xml.namespace.QName("", "bmp"));
