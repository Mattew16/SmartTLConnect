...
public class TrafficInfo  implements java.io.Serializable {
    private com.siemens.sitraffic.vmsinstation.infopoint.PROGRAM PROGRAM;

    public TrafficInfo() {
    }

    public TrafficInfo(
           com.siemens.sitraffic.vmsinstation.infopoint.PROGRAM PROGRAM) {
     ...
     * @return PROGRAM
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.PROGRAM getPROGRAM() {
        return PROGRAM;
    }
     ...
     * @param PROGRAM
     */
    public void setPROGRAM(com.siemens.sitraffic.vmsinstation.infopoint.PROGRAM PROGRAM) {
        this.PROGRAM = PROGRAM;
    }
