...
public class PICTURETypeRENDERED_Helper {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sitraffic.siemens.com/ws/infopoint", ">PICTUREType>RENDERED"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://sitraffic.siemens.com/ws/infopoint", ">>PICTUREType>RENDERED>imgtype"));
        typeDesc.addFieldDesc(attrField);
