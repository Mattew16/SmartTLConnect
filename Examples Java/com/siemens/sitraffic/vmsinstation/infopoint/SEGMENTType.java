...
public class SEGMENTType  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType[] POSITION;
    ...
    public SEGMENTType(
           com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType[] POSITION,
     ...
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType[] getPOSITION() {
        return POSITION;
    }
     ...
     */
    public void setPOSITION(com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType[] POSITION) {
        this.POSITION = POSITION;
    }

    public com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType getPOSITION(int i) {
        return this.POSITION[i];
    }

    public void setPOSITION(int i, com.siemens.sitraffic.vmsinstation.infopoint.SEGMENTPOSITIONType _value) {
