...
public class InfoPoint_Cmd  implements java.io.Serializable {
    private com.siemens.sitraffic.vmsinstation.infopoint.InfoPoint_CmdSwitchCmd switchCmd;

    public InfoPoint_Cmd() {
    }

    public InfoPoint_Cmd(
           com.siemens.sitraffic.vmsinstation.infopoint.InfoPoint_CmdSwitchCmd switchCmd) {
     ...
     * @return switchCmd
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.InfoPoint_CmdSwitchCmd getSwitchCmd() {
        return switchCmd;
    }
     ...
     * @param switchCmd
     */
    public void setSwitchCmd(com.siemens.sitraffic.vmsinstation.infopoint.InfoPoint_CmdSwitchCmd switchCmd) {
        this.switchCmd = switchCmd;
    }
