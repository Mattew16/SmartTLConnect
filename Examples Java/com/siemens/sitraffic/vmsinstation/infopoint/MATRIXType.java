...
public class MATRIXType  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.vmsinstation.infopoint.AREAType[] AREA;
    ...
    public MATRIXType(
           com.siemens.sitraffic.vmsinstation.infopoint.AREAType[] AREA,
     ...
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.AREAType[] getAREA() {
        return AREA;
    }
     ...
     */
    public void setAREA(com.siemens.sitraffic.vmsinstation.infopoint.AREAType[] AREA) {
        this.AREA = AREA;
    }

    public com.siemens.sitraffic.vmsinstation.infopoint.AREAType getAREA(int i) {
        return this.AREA[i];
    }

    public void setAREA(int i, com.siemens.sitraffic.vmsinstation.infopoint.AREAType _value) {
        this.AREA[i] = _value;
    }
