...
public class LocationTypeGeom  implements java.io.Serializable {
    ...
    private com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO[] CO;

    /* true in case of an area */
    private boolean type;

    /* Information about the used coordinate system */
    private com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomSystem system;

    public LocationTypeGeom() {
    }

    public LocationTypeGeom(
           com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO[] CO,
           boolean type,
           com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomSystem system) {
           this.CO = CO;
           this.type = type;
           this.system = system;
    }
     ...
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO[] getCO() {
        return CO;
    }
     ...
     */
    public void setCO(com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO[] CO) {
        this.CO = CO;
    }

    public com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO getCO(int i) {
        return this.CO[i];
    }

    public void setCO(int i, com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomCO _value) {
        this.CO[i] = _value;
    }
     ...
     */
    public com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomSystem getSystem() {
        return system;
    }
     ...
     */
    public void setSystem(com.siemens.sitraffic.vmsinstation.infopoint.LocationTypeGeomSystem system) {
        this.system = system;
    }
